...
export const CAREERS_SECTIONS: SeedSection[] = [
  {
    ...
    data: {
      ...
      lead: "Ticari araç komponentlerini 80+ ülkedeki filo işletmecilerine tedarik ediyoruz. Bilgilerinizi gönderin — her başvuruyu inceliyor ve iki hafta içinde dönüş yapıyoruz.",
      stats: [
        { v: "240+", l: "Ekip üyesi" },
        { v: "12", l: "Milliyet" },
        { v: "25 yıl", l: "Sektörde" },
        { v: "80+", l: "Ülkeye hizmet" },
      ],
