...
import { QMODE_LABELS, QMODES, type QMode } from "@/lib/validation/product-filters";

const SEARCH_PLACEHOLDER: Record<QMode, string> = {
  tumu: "Ürün, stok kodu veya OEM ara…",
  kategori: "Kategori adıyla ara…",
  oem: "OEM / parça no…",
};
  ...
  return (
    <aside className="sidebar">
      ...
      <div className="cat-menu">
        <div className="cat-menu-head">Ürün Kategorileri</div>
        <div className="rule" />
                ...
                >
                  {hasChildren ? (
                    <div
                      ...
                      onClick={() => setOpenId(open ? null : root.id)}
                    >
      ...
      <div className="filters-head">
        <span className="ft">Filtreler</span>
        {hasFilters && (
      ...
      {brands.length > 0 && (
        <div className="filter-group">
          <div className="fg-title">Marka</div>
          {brands.map((b) => {
