...
export default async function HomePage() {
  ...
  const labels: HomeLabels = {
    featuredCta: t("home.featuredCta"),
    newsEmpty: t("home.newsEmpty"),
    newsEmptySide: t("home.newsEmptySide"),
  };
...
function SectionRenderer({
  ...
  switch (section.type) {
    ...
    case "FEATURED_PRODUCTS":
      return (
        <FeaturedSection
          data={section.data as unknown as FeaturedProductsData}
          dynamic={dynamic}
          labels={labels}
        />
      );
    case "NEWSROOM":
      return (
        <NewsSection
          data={section.data as unknown as NewsroomData}
          dynamic={dynamic}
          labels={labels}
        />
      );
  ...
  return (
    <section className="hh-sec hh-news">
      <div className="hh-news__main">
        ...
        {news.length === 0 ? (
          <div className="hh-news__empty">{labels.newsEmpty}</div>
        ) : (
      ...
      <div className="hh-news__side">
        ...
        {news.length === 0 ? (
          <div className="hh-news__empty hh-news__empty--side">{labels.newsEmptySide}</div>
        ) : (
          news.map((n) => (
