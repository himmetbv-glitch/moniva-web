...
type AboutLabels = { home: string; facilityAlt: string };
...
export default async function HakkindaPage() {
  ...
  const labels: AboutLabels = {
    home: t("crumb.home"),
    facilityAlt: t("about.facilityAlt"),
  };
  return (
    <>
      <SiteHeader />
      <main className="about-page">
        {content.sections.map((s) => (
          <AboutSectionRenderer key={s.key} section={s} labels={labels} />
        ))}
      </main>
      <SiteFooter />
    </>
...
function AboutSectionRenderer({
  ...
  switch (section.type) {
    case "ABOUT_HERO":
      return (
        <HeroSection
          d={section.data as unknown as AboutHeroData}
          labels={labels}
        />
      );
    case "ABOUT_FACILITY":
      return (
        <FacilitySection
          d={section.data as unknown as AboutFacilityData}
          labels={labels}
        />
      );
    case "ABOUT_MV":
